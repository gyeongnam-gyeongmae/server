...
@AllArgsConstructor
@Setter
public class PaginatedAuctionItemResponse {
  ...
  public static PaginatedAuctionItemResponse of(AuctionItem auctionItem) {
    return PaginatedAuctionItemResponse.builder()
